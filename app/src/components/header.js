            ...
            <div>
              <AppBar
                ...
                title={
                  <div>
                    <Link to="EPL">
                      <FlatButton style={{ color: "white" }} label="EPL" />
                    </Link>
                    <Link to="Bundesliga">
                      <FlatButton
                        style={{ color: "white" }}
                    ...
                    <Link to="Serie A">
                      <FlatButton style={{ color: "white" }} label="Serie A" />
                    </Link>
                    <Link to="La Liga">
                      <FlatButton style={{ color: "white" }} label="La Liga" />
                    </Link>
                    <Link to="Ligue 1">
                      <FlatButton style={{ color: "white" }} label="Ligue 1" />
                    </Link>
                    <a href="https://nojansworld.herokuapp.com">
                      <FlatButton
                        style={{ color: "white" }}
                        label="Developer's Blog"
                      />
                    </a>
                  </div>
                }
